                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="status" value="1" id="active" checked> <label for="active">{{ __('Active')}}</label>
                                            <input type="radio" name="status" value="0" id="inactive"> <label for="inactive">{{ __('InActive')}}</label>
                                        </div>
                                    </div>
